    ...
    class TrackingDetailWindow : WindowBase
    {
        ...
        public override void WindowUI()
        {
            ...
            if (VesselTracking != null)
            {
                ...
                if (GUILayout.Button("End Current Vessel Tracking", RmmStyle.Instance.ButtonStyle, GUILayout.Height(22)))
                {
            ...
            if (TrackingMission != null)
            {
                ...
                if (TrackingMission.Launch != null)
                {
                    ...
                    GUILayout.Label(launch.Time.ToString("F0"), RmmStyle.Instance.LabelStyle, GUILayout.Width(labelWidth));
                    GUILayout.EndHorizontal();
                    GUILayout.BeginHorizontal();
                ...
                if (TrackingMission.Departure != null)
                {
                    ...
                    GUILayout.BeginHorizontal();
                    GUILayout.Label("Time:", RmmStyle.Instance.LabelStyle, GUILayout.Width(labelWidth));
                    GUILayout.Label(departure.Time.ToString("F0"), RmmStyle.Instance.LabelStyle, GUILayout.Width(labelWidth));
                    GUILayout.EndHorizontal();
                    GUILayout.BeginHorizontal();
                    GUILayout.Label("Body:", RmmStyle.Instance.LabelStyle, GUILayout.Width(labelWidth));
                ...
                if (TrackingMission.Landings != null)
                {
                    foreach (MissionLanding landing in TrackingMission.Landings)
                    {
                        ...
                        GUILayout.BeginHorizontal();
                        GUILayout.Label("Time:", RmmStyle.Instance.LabelStyle, GUILayout.Width(labelWidth));
                        GUILayout.Label(landing.Time.ToString("F0"), RmmStyle.Instance.LabelStyle, GUILayout.Width(labelWidth));
                        GUILayout.EndHorizontal();
                        GUILayout.BeginHorizontal();
                        GUILayout.Label("Body:", RmmStyle.Instance.LabelStyle, GUILayout.Width(labelWidth));
                ...
                if (TrackingMission.Arrival != null)
                {
                    ...
                    GUILayout.BeginHorizontal();
                    GUILayout.Label("Time:", RmmStyle.Instance.LabelStyle, GUILayout.Width(labelWidth));
                    GUILayout.Label(arrival.Time.ToString("F0"), RmmStyle.Instance.LabelStyle, GUILayout.Width(labelWidth));
                    GUILayout.EndHorizontal();
                    GUILayout.BeginHorizontal();
                    GUILayout.Label("Body:", RmmStyle.Instance.LabelStyle, GUILayout.Width(labelWidth));
            ...
            if (VesselTracking == null)
            {
                ...
                GUILayout.BeginHorizontal();
                GUILayout.FlexibleSpace();
                if (GUILayout.Button("Delete Tracking", RmmStyle.Instance.ButtonStyle, GUILayout.Height(22)))
                {
