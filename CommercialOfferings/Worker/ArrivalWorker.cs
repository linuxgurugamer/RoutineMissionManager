...
namespace CommercialOfferings.Worker
{
    public class ArrivalWorker
    {
        ...
        public void StartArrival(RoutineArrivalMission mission, Vessel targetVessel)
        {
            ...
            RmmDockingPortModule.AddToPart(_targetPart);
            var rmmDockingPortModule = _targetPart.Modules.OfType<RmmDockingPortModule>().FirstOrDefault();
            rmmDockingPortModule.SetOnFixedUpdateCallback(OnFixedUpdateArrivalCompletion);
        }

        public void OnFixedUpdateArrivalCompletion()
        {
        ...
        private void dockStage1()
        {
            ...
            if (_mission.Allowed(_targetVessel).CheckSuccess && CrewAvailable())
            {
                _nextLogicTime = Planetarium.GetUniversalTime();
                _arrivalStage = 2;
            }
        ...
        private void dockStage4()
        {
            ...
            if (placePort != null && !RmmUtil.IsDocked(_targetVessel, _targetPart) && checkDockingPortCompatibility(placePort, _targetPart))
            {
        ...
        private void finishArrival()
        {
            ...
            var rmmDockingPortModule = _targetPart.Modules.OfType<RmmDockingPortModule>().FirstOrDefault();
            rmmDockingPortModule.SetOnFixedUpdateCallback(null);
        }
